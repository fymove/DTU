...
typedef struct {  
    ...
    u32 Active_Power_Total;                                            //总有功功率
    u32 Reactive_Power_Total;                                        //总无功功率
    u32 Apparent_Power_Total;                                        //总视在功率
